...
prob1 = alg_dae_isol2seg(prob1, '', @gfunc, @gfunc_dt, @gfunc_dx, ...
    @gfunc_dy, @gfunc_dp);
...
prob2 = alg_dae_sol2seg(prob2, '', 'linode1', BPlab(1));
...
prob2 = adjt_alg_dae_sol2seg(prob2, '', 'linode1', BPlab(1), 'BP');
...
prob3 = alg_dae_sol2seg(prob3, '', 'linode2', lab(2));
...
prob3 = adjt_alg_dae_sol2seg(prob3, '', 'linode2', lab(2));
