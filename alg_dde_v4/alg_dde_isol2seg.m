function prob = alg_dde_isol2seg(prob, oid, gidx, varargin)
...
% VARARGIN = {gidx, yidx, {@s^2,@s^3,...,@s^nd-1},{g1,g2,...,g_nd}}
% g1 = {@gfunc,(@tau^x | '[]'),(@tau^t | '[]'),(@phi |'[]'),dg,dtaux,dtaut,@dotphi}
% dg = {@dgdt,@dgdy,[@dgdx],[@dgdphi],@dgdp}
...
tbid = coco_get_id(oid, 'alg_dde'); % Create toolbox instance identifier
...
data = alg_dde_init_data(data);        % Build toolbox data
prob = alg_dde_construct_seg(prob, tbid, data); % Append continuation problem
