...
coll_args = [funcs, {[0; 1], [0 0;0 0], {'l1', 'l2', 'l3'}, [0;0.1;0.1]}];
...
cont_pars =  {'obj', 'l1', 'd.obj', 'd.coll.T0', 'd.l2', 'd.l3', 'd.l1'};
...
cont_pars = {'d.obj', 'obj', 'l1', 'd.coll.T0', 'd.l2', 'd.l3', 'd.l1'};
...
% % computational domain
chart = coco_read_adjoint('coll.pars', 'obv2', lab, 'chart');
dl20 = chart.x(2);
if dl20>0
  dl2_int = [-0.1 dl20];
...
cont_pars = {'d.l2', 'l1', 'l2', 'obj', 'd.coll.T0', 'd.l3', 'd.l1'};
coco(prob3, 'obv3', [], cont_pars, {dl2_int, p1, p2, objint});
...
% if dl30>0
%   dl3_int = [-0.1 dl30];
%   prob3 = coco_add_event(prob3, 'opt', 'BP', 'd.l3', '<', 0);
% else
%   dl3_int = [dl30 0.1];
%   prob3 = coco_add_event(prob3, 'opt', 'BP', 'd.l3', '>', 0);
% end
% cont_pars = {'d.l3', 'l1', 'l3', 'obj', 'd.coll.T0', 'd.l2', 'd.l1'};
% coco(prob3, 'obv3', [], cont_pars, {dl3_int, p1, p3, objint});
...
% if dl10>0
%   dl1_int = [-0.1 dl10];
%   prob3 = coco_add_event(prob3, 'opt', 'BP', 'd.l1', '<', 0);
% else
%   dl1_int = [dl10 0.1];
%   prob3 = coco_add_event(prob3, 'opt', 'BP', 'd.l1', '>', 0);
% end
% cont_pars = {'d.l1', 'l2', 'l1', 'obj', 'd.coll.T0', 'd.l3', 'd.l2'};
% coco(prob3, 'obv3', [], cont_pars, {dl1_int, p2, p1, objint});
...
%   prob3 = coco_add_event(prob3, 'opt', 'BP', 'd.l3', '>', 0);
% end
% cont_pars = {'d.l3', 'l2', 'l3', 'obj', 'd.coll.T0', 'd.l1', 'd.l2'};
% coco(prob3, 'obv3', [], cont_pars, {dl3_int, p2, p3, objint});
...
%   prob3 = coco_add_event(prob3, 'opt', 'BP', 'd.l1', '>', 0);
% end
% cont_pars = {'d.l1', 'l3', 'l1', 'obj', 'd.coll.T0', 'd.l2', 'd.l3'};
% coco(prob3, 'obv3', [], cont_pars, {dl1_int, p3, p1, objint});
...
% end
% 
% cont_pars = {'d.l2', 'l3', 'l2', 'obj', 'd.coll.T0', 'd.l1', 'd.l3'};
% coco(prob3, 'obv3', [], cont_pars, {dl2_int, p3, p2, objint});
...
coco(prob4, 'obv4', [], cont_pars, {dl3_int, objint, p1, p2, p3});
...
% if dl20>0
%   dl2_int = [-0.1 dl20];
%   prob4 = coco_add_event(prob4, 'opt', 'BP', 'd.l2', '<', 0);
% else
%   dl2_int = [dl20 0.1];
%   prob4 = coco_add_event(prob4, 'opt', 'BP', 'd.l2', '>', 0);
% end
% 
% cont_pars = {'d.l2', 'obj', 'l1', 'l2', 'l3', 'd.coll.T0', 'd.l1'};
% coco(prob4, 'obv4', [], cont_pars, {dl2_int, objint, p1, p2, p3});
...
% end
% 
% cont_pars = {'d.l3', 'obj', 'l2', 'l1', 'l3', 'd.coll.T0', 'd.l1'};
% coco(prob4, 'obv4', [], cont_pars, {dl3_int, objint, p2, p1, p3});
...
% if dl10>0
%   dl1_int = [-0.1 dl10];
%   prob4 = coco_add_event(prob4, 'opt', 'BP', 'd.l1', '<', 0);
% else
%   dl1_int = [dl10 0.1];
%   prob4 = coco_add_event(prob4, 'opt', 'BP', 'd.l1', '>', 0);
% end
% 
% cont_pars = {'d.l1', 'obj', 'l2', 'l3', 'l1', 'd.coll.T0', 'd.l2'};
% coco(prob4, 'obv4', [], cont_pars, {dl1_int, objint, p2, p3, p1});
...
% end
% 
% cont_pars = {'d.l2', 'obj', 'l3', 'l1', 'l2', 'd.coll.T0', 'd.l3'};
% coco(prob4, 'obv4', [], cont_pars, {dl2_int, objint, p3, p1, p2});
...
% end
% 
% cont_pars = {'d.l1', 'obj', 'l3', 'l2', 'l1', 'd.coll.T0', 'd.l3'};
% coco(prob4, 'obv4', [], cont_pars, {dl1_int, objint, p3, p2, p1});
