...
[chart, aidx] = coco_read_adjoint('gfunc', 'obv1', lab, 'chart', 'lidx');
...
prob3   = coco_add_adjt(prob3, 'bc', 'aidx', ...
  axidx([opt.T_idx; opt.x0_idx; opt.x1_idx; opt.p_idx; opt.T0_idx]), ...
  'l0', chart.x);
chart = coco_read_adjoint('gfunc', 'obv2', lab, 'chart');
...
prob4 = coco_add_func(prob4, 'bc', bc_funcs{:}, [], 'zero', ...
  'uidx', uidx([maps.T_idx; maps.x0_idx; maps.x1_idx; maps.p_idx; maps.T0_idx]));
prob4 = coco_add_func(prob4, 'gfunc',@coup, data,'zero','uidx',[data.xbp_idx;data.ybp_idx]);
...
prob4   = coco_add_adjt(prob4, 'bc', 'aidx', ...
  axidx([opt.T_idx; opt.x0_idx; opt.x1_idx; opt.p_idx; opt.T0_idx]), ...
  'l0', chart.x);
chart = coco_read_adjoint('gfunc', 'obv3', lab, 'chart');
prob4 = coco_add_adjt(prob4, 'gfunc', @adj_coup, data, 'aidx', ...
  axidx([opt.xcn_idx; opt.ycn_idx]),'l0', chart.x);
