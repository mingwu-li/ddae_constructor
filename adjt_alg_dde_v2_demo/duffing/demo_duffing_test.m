...
coco(prob, 'coll0', [], 1, cont_pars, {[],[],[],[0 0.05]});
...
% prob = coco_set(prob, 'ddaecoll', 'NTST', 10);
% original
prob = ddaecoll_sol2seg(prob, '', 'coll0', 2); % Reconstruct 'coll' continuation problem
prob = alg_dde_sol2seg(prob, '', 'g1', 'coll0', 2);
...
% adjoint
prob = adjt_ddaecoll_sol2seg(prob, '', 'coll0', 2);
prob = adjt_alg_dde_sol2seg(prob, '', 'g1', 'coll0', 2);
...
cont_pars = {'amp' 'd.amp' 'phi' 'alpha' 'd.zeta' 'd.a' 'd.b' 'd.alpha' 'd.f' 'd.Omega'};
coco(prob, 'coll1', [], 1, cont_pars, {[],[],[],[0 0.5]});
