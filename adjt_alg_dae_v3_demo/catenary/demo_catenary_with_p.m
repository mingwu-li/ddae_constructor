...
prob = alg_dae_isol2seg(prob, '', @gfunc, @gfunc_dt, @gfunc_dx, ...
    @gfunc_dy, @gfunc_dp_v2);
...
prob = adjt_alg_dae_isol2seg(prob, '');
...
prob = alg_dae_sol2seg(prob, '', 'cant1', BPlab);
...
prob = adjt_alg_dae_sol2seg(prob, '', 'cant1', BPlab, 'BP');
[data, axidx] = coco_get_adjt_data(prob, 'ddaecoll', 'data', 'axidx');
opt = data.ddaecoll_opt;
